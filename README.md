...
Signals used
  1. Sinusoidal signals representing simplified biomedical signals (similar to ECG or EMG components) 
  2. Linear time-invariant (LTI) system implemented using basic mathematical operations
  3. MATLAB plots to visually compare expected and actual outputs
